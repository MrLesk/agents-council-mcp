...
- [ok] Persistent across all sessions in a project
- [ok] Shared with team via git
- [ok] Automatic discovery (no code changes needed)
- [warn] Requires loading settings via `settingSources`
